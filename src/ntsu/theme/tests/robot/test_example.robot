...
#
#  $ bin/test -s ntsu.theme -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src ntsu.theme.testing.NTSU_THEME_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/ntsu/theme/tests/robot/test_example.robot
#
